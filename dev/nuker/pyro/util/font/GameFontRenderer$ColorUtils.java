...
class GameFontRenderer$ColorUtils {
   ...
   public static String randomMagicText(String text) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         if (ChatAllowedCharacters.isAllowedCharacter(ch)) {
            int index = random.nextInt("ÀÁÂÈÊËÍÓÔÕÚßãõğİıŒœŞşŴŵžȇ\u0000\u0000\u0000\u0000\u0000\u0000\u0000 !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u0000ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αβΓπΣσμτΦΘΩδ∞∅∈∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■\u0000".length());
   ...
   static {
      ...
      hexColors[2] = 43520;
      hexColors[3] = 43690;
      hexColors[4] = 11141120;
      hexColors[5] = 11141290;
      hexColors[6] = 16755200;
      hexColors[7] = 11184810;
      hexColors[8] = 5592405;
      hexColors[9] = 5592575;
      hexColors[10] = 5635925;
      hexColors[11] = 5636095;
      hexColors[12] = 16733525;
      hexColors[13] = 16733695;
      hexColors[14] = 16777045;
      hexColors[15] = 16777215;
      random = new Random();
   }
}
