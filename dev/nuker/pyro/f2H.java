...
public class f2H implements Command {
   ...
   public static f2H field_1995 = new f2H();
   ...
   public int run(@Nullable CommandContext var1) {
      ...
      if (var3.isPresent()) {
         ...
         if ((Boolean)((Module)var3.get()).field_89.method_3034()) {
            ...
            ((f1s)var10000).method_3083((new TextComponentString("Module Already Enabled: ")).appendSibling((new TextComponentString(((Module)var3.get()).method_127())).setStyle((new Style()).setColor(TextFormatting.DARK_AQUA))));
         } else {
            ((Module)var3.get()).field_89.method_3033(true);
            if (var1 == null) {
               Intrinsics.throwNpe();
            }
            ...
            ((f1s)var10000).method_3083((new TextComponentString("Enabled Module: ")).appendSibling((new TextComponentString(((Module)var3.get()).method_127())).setStyle((new Style()).setColor(TextFormatting.DARK_AQUA))));
         }
