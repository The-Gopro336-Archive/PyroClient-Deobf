...
public class f3s implements SuggestionProvider {
   // $FF: renamed from: c dev.nuker.pyro.f3s
   public static f3s field_2171 = new f3s();

   public CompletableFuture getSuggestions(@Nullable CommandContext var1, @NotNull SuggestionsBuilder var2) {
      Iterator var4 = PyroStatic.field_2584.method_1107().method_2666().iterator();
