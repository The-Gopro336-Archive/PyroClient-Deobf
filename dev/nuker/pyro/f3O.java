...
public class f3O implements Command {
   ...
   public static f3O field_2115 = new f3O();
   ...
   public int run(CommandContext var1) {
      ...
      if (Block.REGISTRY.containsKey(new ResourceLocation(var2))) {
         if (PyroStatic.field_2488.method_1046().method_2817().contains(var2)) {
            ((f1s)var1.getSource()).method_3083((new TextComponentString(var2 + " is already an xray block")).setStyle((new Style()).setColor(TextFormatting.RED)));
         } else {
            PyroStatic.field_2488.method_1046().method_2817().add(var2);
            ((f1s)var1.getSource()).method_3083((ITextComponent)(new TextComponentString("Added xray block " + var2)));
