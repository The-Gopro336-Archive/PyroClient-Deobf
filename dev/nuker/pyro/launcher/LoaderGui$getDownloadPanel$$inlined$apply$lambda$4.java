...
@Metadata(
   ...
   d2 = {"dev/nuker/pyro/launcher/LoaderGui$getDownloadPanel$1$1$6", "Ljava/awt/event/FocusListener;", "focusGained", "", "e", "Ljava/awt/event/FocusEvent;", "focusLost", "pyroclient", "dev/nuker/pyro/launcher/LoaderGui$$special$$inlined$apply$lambda$8"}
)
public final class LoaderGui$getDownloadPanel$$inlined$apply$lambda$4 implements FocusListener {
   ...
   LoaderGui$getDownloadPanel$$inlined$apply$lambda$4(JComboBox var1, JComboBox var2, JButton var3, Map var4, Function0 var5, Function2 var6) {
