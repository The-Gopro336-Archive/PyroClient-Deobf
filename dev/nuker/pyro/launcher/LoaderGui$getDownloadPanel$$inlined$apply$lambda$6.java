...
@Metadata(
   ...
   k = 3,
   d1 = {"\u0000 \n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\b\u0002\n\u0002\b\u0003\n\u0002\b\u0003\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u0003H\n¢\u0006\u0002\b\u0005¨\u0006\u0007"},
   d2 = {"<anonymous>", "", "it", "Ljava/awt/event/ActionEvent;", "kotlin.jvm.PlatformType", "actionPerformed", "dev/nuker/pyro/launcher/LoaderGui$getDownloadPanel$1$1$8", "dev/nuker/pyro/launcher/LoaderGui$$special$$inlined$apply$lambda$10"}
)
final class LoaderGui$getDownloadPanel$$inlined$apply$lambda$6 implements ActionListener {
   ...
   LoaderGui$getDownloadPanel$$inlined$apply$lambda$6(JComboBox var1, JComboBox var2, JButton var3, Map var4, Function0 var5, Function2 var6) {
   ...
   public final void actionPerformed(ActionEvent it) {
      Function2 var10000 = this.$selectCallback$inlined;
      Object var10001 = this.$channelBox$inlined.getSelectedItem();
      if (var10001 == null) {
         throw new TypeCastException("null cannot be cast to non-null type kotlin.String");
      } else {
         String var2 = (String)var10001;
         Object var10002 = this.$versionBox$inlined.getSelectedItem();
         if (var10002 == null) {
            throw new TypeCastException("null cannot be cast to non-null type kotlin.String");
         } else {
            var10000.invoke(var2, (String)var10002);
