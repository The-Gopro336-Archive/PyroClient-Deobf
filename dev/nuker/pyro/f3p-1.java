...
public class f3p implements Command {
   // $FF: renamed from: c dev.nuker.pyro.f3p
   public static f3p field_2177 = new f3p();
   ...
   public int run(CommandContext var1) {
      ...
      if (Block.REGISTRY.containsKey(new ResourceLocation(var2))) {
         if (PyroStatic.field_2584.method_1107().method_2666().contains(var2)) {
            ((f1s)var1.getSource()).method_3083((new TextComponentString(var2 + " is already an search block")).setStyle((new Style()).setColor(TextFormatting.RED)));
         } else {
            PyroStatic.field_2584.method_1107().method_2666().add(var2);
            ((f1s)var1.getSource()).method_3083((ITextComponent)(new TextComponentString("Added search block " + var2)));
