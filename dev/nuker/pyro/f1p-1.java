...
public class f1p implements Command {
   // $FF: renamed from: c dev.nuker.pyro.f1p
   public static f1p field_1996 = new f1p();
   ...
   public int run(CommandContext var1) {
      ...
      if (Item.REGISTRY.containsKey(new ResourceLocation(var2))) {
         if (!PyroStatic.field_2595.method_472().method_3048().contains(var2)) {
            ((f1s)var1.getSource()).method_3083((new TextComponentString(var2 + " is not an cheststealer block")).setStyle((new Style()).setColor(TextFormatting.RED)));
         } else {
            PyroStatic.field_2595.method_472().method_3048().remove(var2);
            ((f1s)var1.getSource()).method_3083((ITextComponent)(new TextComponentString("Removed cheststealer block " + var2)));
